  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const data = await fetch(
        `http://localhost:8095/subscriptionPlan/subscriptionPlan`
    ...
    <>
      ...
      <div className="subscription">
        ...
        <div className="subscription-right">
            ...
            <div className="subscription-registrationform">
              {subscriptionPlan.map((subscriptionPlan) => (
                <div
                  key={subscriptionPlan.subscriptionPlanId}
                  className={`${subscriptionPlan.subscriptionPlanName.toLowerCase()}subscriptionPlan`}
                >
                  <p className="tx-1">
                  ...
                  <p className="tx-3">
                    {subscriptionPlan.subscriptionPlanDescription}
                  </p>
                  {/* <div className="UL">
                  ...
                  <button className="buynowbutton" type="submit" onClick={handleSubmit}>
                  SELECT
              </button>
                </div>
              ))}
